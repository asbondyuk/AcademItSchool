...
public class Main {
    public static void main(String[] args) {
        ...
        Matrix matrix7 = new Matrix(new Vector[]{new Vector(new double[]{3, 3, 3}), new Vector(new double[]{4, 4, 4}), new Vector(new double[]{5, 5, 5})});
        System.out.printf("Результат перемножения: %s%n", Matrix.multiply(matrix7, matrix5));
    }
}